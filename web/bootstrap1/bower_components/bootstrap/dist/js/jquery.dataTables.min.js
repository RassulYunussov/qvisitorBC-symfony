...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Первая",sLast:"Последняя",sNext:"Следующая",sPrevious:"Предыдущая"},sEmptyTable:"Не найдено ни одной записи",sInfo:"Показаны c _START_ по _END_ из _TOTAL_ записей",sInfoEmpty:"Показаны 0 to 0 из 0 записей",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показаны _MENU_ записей",sLoadingRecords:"Загрузка...",sProcessing:"Пожалуйста подождите...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Не найдено ни одной записи"},
